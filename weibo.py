...
fo = open("C:\Users\liker\PycharmProjects\untitled\pic\%s"%user_id, "wb")
fo.write(result)
word_path=os.getcwd()+'/%d'%user_id
print u'文字微博爬取完毕'

link = ""
fo2 = open("C:\Users\liker\PycharmProjects\untitled\pic\%s_imageurls"%user_id, "wb")
